...
/// @nodoc
@JsonSerializable()
class _$_TicketDto implements _TicketDto {
  const _$_TicketDto({required this.slot});
...
abstract class _TicketDto implements TicketDto {
  const factory _TicketDto({required final String slot}) = _$_TicketDto;
